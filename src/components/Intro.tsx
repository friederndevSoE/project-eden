...
export default function IntroScreen() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => setShow(false), 1600); // 2 seconds
  ...
  return (
    <AnimatePresence>
      {show && (
        ...
        >
          <p className="md:text-2xl flex items-center gap-2 font-[200]">
            This site is accompanied by music
            <svg
            ...
            >
              <path
                fill="#ffffff"
                d="M18 0C9.716 0 3 6.716 3 15v9h3v-9C6 8 11.269 2.812 18 2.812C24.73 2.812 30 8 30 15v10l3-1v-9c0-8.284-6.716-15-15-15z"
              ></path>
              <path
                fill="#ffffff"
                d="M6 27a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-9a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v9zm30 0a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2v-9a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v9z"
              ></path>
              <path
                fill="#d6ae63"
